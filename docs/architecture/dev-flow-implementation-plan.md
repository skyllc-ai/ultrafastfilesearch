...
- [x] **Nextest archive round-trip** validation: Windows box with
      ...
      in `uffs-security` and `uffs-mft` — filed as follow-up PRs
...
- **Phase 5 wrap-up PR** — after follow-up PRs #53 (uffs-security
  fnv1a test vector) and #54 (uffs-mft pipelined buffer size) land,
...
- **PR #53 tracking** (follow-up) — `uffs-security`
...
- **PR #54 tracking** (follow-up) — `uffs-mft`
