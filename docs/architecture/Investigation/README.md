...
This directory holds exploratory notes, parity deep dives, and one-off debugging artifacts.

## Canonicalization policy

- Prefer stable docs in `docs/architecture/` when both a stable and investigative copy exist.
...
- `MFTINDEX_DEEP_DIVE.md`
- `tree-metrics-algorithm-question.md`
- `tree_metrics_optimized.md`
