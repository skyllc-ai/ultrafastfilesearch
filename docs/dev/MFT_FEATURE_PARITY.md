...
> between the reference baseline (`old_cpp_reference/uffs/UltraFastFileSearch-code/file.cpp` in the optional repo-root, gitignored local-only tree) and the Rust
