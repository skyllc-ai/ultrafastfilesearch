...
#[expect(
    unsafe_code,
    reason = "set_var called once at CLI startup in main thread before spawning workers"
)]
#[expect(
    clippy::single_call_fn,
    reason = "extracted from search() to reduce cognitive complexity"
)]
#[expect(
    clippy::semicolon_inside_block,
    clippy::semicolon_outside_block,
    reason = "mixed block styles from unsafe blocks"
)]
