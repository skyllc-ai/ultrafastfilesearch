...
// Date: 2024-07-28
// ------------------------------------------------------------------------------
// Description: This module initializes and configures the logging system for
// the              Ultra Fast File Search Tool (UFFS). It sets up both terminal
// and              file-based logging with environment-based log levels and
// ensures              that log files are created and managed properly.
// ------------------------------------------------------------------------------
...
// Function to get the logging level from the environment variable or default to
// LevelFilter::Info
