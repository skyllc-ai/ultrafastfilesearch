...
//! ```
// =============================================================================
// scripts/build-local.rs - UFFS Local Build & Install (Windows Only)
// =============================================================================
//
...
fn main() {
    ...
    if host_os != "windows" {
        ...
        println!("   Use 'rust-script scripts/build-cross-all.rs' to cross-compile for Windows.\n");
    }
...
fn ensure_dist_files_tracked(version: &str) {
    ...
    // Force add all dist files including symlinks and binaries
    let commands = vec![
        vec!["add", "dist/"],
        vec!["add", "-f", "dist/latest"], // Force add symlink
