#!/bin/bash
# =============================================================================
# scripts/create-profiling-bundle.sh - Create a profiling bundle for Windows analysis
# =============================================================================
#
...
#
# Usage:
#   ./scripts/create-profiling-bundle.sh [scenario_name]
#
# Example:
#   ./scripts/create-profiling-bundle.sh mft_large_cold_cache
#
...
if ! rust-script scripts/build-cross-all.rs; then
